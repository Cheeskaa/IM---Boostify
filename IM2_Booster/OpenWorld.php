...
<head>
    ...
    <title>Boostify | Know More</title>
</head>
<body class="OWBody">
...
<header class="OWHeader">
    <nav class="navbar">
        ...
        <div class="navbar_right">
            ...
            <div class="nav-order"><a class="btn" href="ClientOrders.php"><i class='bx bxs-notepad'></i><p>ORDERS</p></a></div>
            <div class="nav-booster"><a class="btn active" href="#"><i class='bx bxs-game'></i><p>GAME LIST</p></a></div>
            <!-- <div class="nav-menu">
    ...
    <section class="mainlist">
        <div class="Open-World"><p><b>Open-World</b></p></div>  
    
    <main class="OWGameList">
            <div class="game1">
                <img src="Images/Terraria.png" alt="Terraria" width="400" height="300">
                <p class="gametitle">Terraria</p>
                <p>Blending elements of classic action games with the freedom of sandbox-style 
                    creativity, Terraria is a unique gaming experience where both the journey and 
                    the destination are as unique as the players themselves!</p>
            </div>
            <div class="game1">
                <img src="Images/EldenRing.webp" alt="Elden-Ring" width="400" height="300">
                <p class="gametitle">Elden Ring</p>
                <p>A vast world where open fields with a variety of situations and huge dungeons with 
                    complex and three-dimensional designs are seamlessly connected.</p>
            </div>
            <div class="game1">
                <img src="Images/CyberPunk.avif" alt="CyberPunk" width="400" height="300">
                <p class="gametitle">Cyberpunk 2077</p>
                <p>Cyberpunk 2077 is an open-world, action-adventure RPG set in the dark future of 
                    Night City — a dangerous megalopolis obsessed with power, glamor, and ceaseless body modification.</p>
            </div>
            <div class="game1">
                <img src="Images/WutheringWaves.jpg" alt="WutheringWaves" width="400" height="300">
                <p class="gametitle">Wuthering Waves</p>
                <p>Companions to meet, enemies to conquer, new powers to gain, hidden truths to unveil, and unseen spectacles 
                    to behold... A vast world of endless possibilities awaits. The choice rests in your hands.</p>
            </div>
            <div class="game1">
                <img src="Images/SeaOfThieves.webp" alt="SeaThieves" width="400" height="300">
                <p class="gametitle">Sea of Thieves </p>
                <p>Sea of Thieves offers the essential pirate experience, from sailing and fighting to exploring and looting – 
                    everything you need to live the pirate life and become a legend in your own right. </p>
            </div>
            <div class="game1">
                <img src="Images/Terraria.png" alt="Terraria" width="400" height="300">
                <p class="gametitle">Terraria</p>
