...
<header class="OWHeader">
    <nav class="navbar">
        ...
        <div class="navbar_right">
            <div class="nav-home"><a class="btn active" href="ClientHomePage.php"><i class='bx bxs-home'></i><p>HOME</p></a></div>
    ...
    <h2>Welcome to Boostify<br><?php echo htmlspecialchars($username); ?></h2><!---------------ANG NAME, BASIN INYO BUTNGAN OG BACKEND----------->
        <div class="Search"><input class="Search-text" type="text"><i class='bx bx-search'></i></div>
        <div class="Details-Services">
            <h3>BOOSTER DETAILS AND SERVICES:</h3>
            <div class="Order-Status"> <!-------------------GROUP ANG STATUS_UPDATE---------------------->
                <div class="Status_update"> <!-------------------ANG BOX NGA ORDER STATUS----------------------->
                    <div class="profpic_status"> <!---------------ARON MA ALIGN ANG PROFILE OG DESCRIPTIONS------------------>
                        <img src="Images/profile.svg" alt="">
                        <div class="Status_description"> <!-------------------GROUP SA WORDS CHU2------------------------>
                            <div class="In-progress"> <!--------------PARA MA ALIGN ANG IN-PROGRESS OG CHANGE COLOR----------------->
                                <p>ORDER STATUS:</p>
                                <p class="fenk">In-Progress</p>
                            </div>
                            ...
                            <p class="Intro-booster">“An ex-pro Valorant player in Team Warriors”<br>Services Offered: Genshin and Valorant</p>
                        </div>    
                    </div>
                    <a class="Know-More" href="ClientBoosterProfile.html">Know More</a>
                </div>
                <div class="Status_update"> <!-------------------ANG BOX NGA ORDER STATUS----------------------->
                    <div class="profpic_status"> <!---------------ARON MA ALIGN ANG PROFILE OG DESCRIPTIONS------------------>
                        <img src="Images/profile.svg" alt="">
