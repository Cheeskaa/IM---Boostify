...
<header class="OWHeader">
    <nav class="navbar">
        ...
        <div class="navbar_right">
            ...
            <div class="nav-booster"><a class="btn" href="#"><i class='bx bxs-game'></i></i><p>GAME LIST</p></a></div>
            <!-- <div class="nav-menu">
...
<main class="Orders-main">
    <h1>ORDERS</h1>
    <div class="CombinationSaBox">
        <div class="Status-Add">
            <div class="Status-box">
                <div class="Angorderstatus">
                    <h4>ORDER STATUS:</h4>
                    <p>In-Progress</p>
                </div>
                <p>BOOSTER DETAILS AND SERVICES:</p>
                <div class="AngboxsudsaStatus-box">
                    <img src="/Images/profile.svg" alt="">
                    ...
                    <p>“An ex-pro Valorant player in Team Warriors”</p>
                    <p>Services Offered: Genshin and Valorant</p>
                    <h6>Know More</h6>
                </div>
            </div>

            <a class="Add-box" href="Add-Order.php"><div>
                <h3>ADD ORDER</h3>
                <div class="FordaCircle"><i class='bx bx-plus-medical'></i></div>
            </div></a>
        </div>
