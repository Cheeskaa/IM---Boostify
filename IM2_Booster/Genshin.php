...
<header class="OWHeader">
    ...
    <div class="GenshinTitle">
        <h1>Genshin Impact</h1>
    </div>

    <div class="AboutTheGame">
        <img src="Images/genshinImpact.jpg" width="400" height="300">
        <div class="descriptionOfGame">
            <div class="AboutGenshin">About The Game</div>
            <p>A pair of "star traveler" twins who visit different worlds 
                arrive in the world of Teyvat and witness the destruction 
                of the nation of Khaenri'ah. While attempting to flee the 
                chaos, an unnamed god blocks their path and separates them: 
                she captures one and seals away the power of the other. 
                The sealed twin (known as the "Traveler") awakens five hundred 
                years later and meets Paimon, who becomes their companion. For 
                months, they travel together and then make their way to Mondstadt. 
                There, they begin the search for the Traveler's missing sibling.</p>
        </div>
    </div>
<!------------------------------PRICES---------------------------------->    
    <div class="GenshinTitle">
    ...
    <div class="GPrices">
        <div class="maintainance-container">
            <h3>MAINTAINANCE</h3>
                <div class="day-price">
                    <div class="day-commisions">
                        <h4><b>1 DAY</b></h4>
                        <p>commisions, resin burn, daily bp, expeditions</p>
                    </div>
                    <p class="pesos20"><b>20 PHP</b></p>
                </div>
                <div class="day-price">
                    <div class="day-commisions">
                        <h4><b>1 DAY</b></h4>
    ...
    <div class="GBoosters">
        <div class="Top5-Boosters"><p>Top 5 Genshin Boosters</p></div>
        <div class="ListOfBoosters">
            <div class="booster-container">
                <div class="name-profpic">
                    <p>Clive Owen Delima</p>
                    <img src="Images/profile.svg" alt="">
                </div>
